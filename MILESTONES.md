# Milestones: Pocket Monsters Scarlet

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-Scarlet-Decompilation`.
...
| Field | Current value |
| --- | --- |
| Target | Pocket Monsters Scarlet |
...
Coordinate with Violet and model every update or downloadable-content version as a separate identified target.
