# Scarlet — Exhaustive Defect Eradication

## Target

- Game: Pocket Monsters Scarlet
- Generation: IX
...
For Scarlet, include every row targeting `Scarlet` or `Scarlet|Violet`, plus every newly discovered Scarlet-only defect.

## Mandatory Scarlet coverage
...
- Scarlet-only encounter/data/event differences
- Koraidon-specific field/battle/model behavior
- Naranja Academy-specific content and text
...
1. Identify the exact local Scarlet input build and update/DLC combination.
