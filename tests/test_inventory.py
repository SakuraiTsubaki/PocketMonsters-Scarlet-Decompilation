...
class InventoryTests(unittest.TestCase):
    ...
    def test_tree_digest_ignores_absolute_root_location(self):
        with tempfile.TemporaryDirectory() as tmp_a, tempfile.TemporaryDirectory() as tmp_b:
            ...
            inventory_a = inventory_tool.build_inventory(root_a)
            inventory_b = inventory_tool.build_inventory(root_b)
            self.assertEqual(inventory_a["tree_sha256"], inventory_b["tree_sha256"])
